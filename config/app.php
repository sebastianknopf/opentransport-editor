...
return [
    ...
    'App' => [
        ...
        'repositoryCredentials' => env('APP_REPOSITORY_CREDENTIALS', false),
        ...
        'useHttps' => env('APP_USE_HTTPS', false),
        'fullBaseUrl' => false,
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
    ...
    /**
     * Settings for frontend display.
     * allowUnauthenticated - Whether you allow frontend access without authentication.
     * preferredLocale - The default language for your frontend. Set to false to auto detect from request data.
     */
    'Frontend' => [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '8cebc64540e6717be83b890194c69b7d58ed4fffb973c6ca73b127de2b9cd4c1'),
    ],
