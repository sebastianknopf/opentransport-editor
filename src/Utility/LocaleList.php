...
class LocaleList
{
    ...
    /**
     * Transforms a locale code into a full locale string.
     *
     * @param $key Locale code.
     * @return mixed Locale full name.
     */
    public static function getLocaleName($key)
    {
        return self::$codes[strtolower($key)];
    }

    /**
     * Returns the user preferred default language determined by accept language.
     *
     * @return bool|mixed|string The preferred default lang
     */
    public static function getPreferredLocale()
    {
        $lang = substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2);
        $lang = array_key_exists($lang, self::getLocaleList()) ? $lang : Configure::read('App.defaultLocale');
