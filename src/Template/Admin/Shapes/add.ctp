                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabBasedata">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?= $this->Form->control('shape_name', ['type' => 'text', 'label' => __('Name')]) ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
...
<script>
    $(function () {
        ...
        <?php if(count($shape->points)): ?>
        tooltip.text('<?= __('Click Strg+Point to continue the line.') ?>');
        <?php else: ?>
        tooltip.text('<?= __('Click on the map to start a new line.') ?>');
        <?php endif; ?>
        ...
        <?php else: ?>
        // begin new polyline
        var polyline = mapView.editTools.startPolyline();
        <?php endif; ?>
