                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content bg-white p-4">
                            <div class="tab-pane active" id="tabBasedata">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <?= $this->Form->control('route_id', ['label' => __('Route'), 'options' => $routes, 'value' => $route_id]) ?>
                            ...
                            <!--<div class="tab-pane" id="tabGraphicTimes">
                                ...
                                <?php //$this->element('editor/graphic-timetable') ?>
                                <?php //$this->end(); ?>
                            </div>-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12 table-responsive">
                                        <table class="table w-100">
                                            <thead>
                                            <tr>
                                                <th width="150" class="text-center"><?= __('Start Time') ?></th>
                                                <th width="150" class="text-center"><?= __('End Time') ?></th>
                                                <th width="200" class="text-center"><?= __('Headway') ?></th>
                                                <th width="200" class="text-center"><?= __('Exact Times') ?></th>
                                                <th class="text-right">
...
<script>
    $(function () {
        ...
        $(document).on('click', '.lnk-delete-stoptime', function (e) {
            ...
            let stopId = $(this).closest('tr').find('.inp-stop-id').val();
