                        ...
                        <div class="tab-content bg-white p-4">
                            <div class="tab-pane active" id="tabBasedata">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <?= $this->Form->control('agency_id', ['label' => __('Agency'), 'options' => $agencies]) ?>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <div id="routeColor" class="input-group colorpicker-component">
                                                    <?= $this->Form->input('route_color', ['label' => false]) ?>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <div id="routeTextColor" class="input-group colorpicker-component">
                                                    <?= $this->Form->input('route_text_color', ['label' => false]) ?>
                                                    <span class="input-group-addon"><i></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-center" style="padding-top: 35px;padding-bottom: 20px;">
                                            <span id="colorPreview" class="label" style="font-size:2em;background-color:<?= $route->route_color ?>;color:<?= $route->route_text_color ?>;">Sample Text</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
