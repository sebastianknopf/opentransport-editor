...
class MessagesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->addBehavior('Tools.Bitmasked', ['mappedField' => 'flags', 'field' => 'flags']);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('entity_source')
            ->maxLength('entity_source', 255)
            ->allowEmptyString('entity_source');

        $validator
            ->scalar('short_message')
            ->maxLength('short_message', 255)
            ->requirePresence('short_message', 'create')
            ->allowEmptyString('short_message', false);

        $validator
            ->scalar('long_message')
            ->requirePresence('long_message', 'create')
            ->allowEmptyString('long_message', false);
